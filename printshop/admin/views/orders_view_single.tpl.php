...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <meta charset="utf-8">
    <title>CAMDY Print Shop - Printing Gift App</title>
								...
								<table class="table table-striped">
							      ...
							      <tbody>
							        ...
							        <tr>
							          ...
							          <td>
							          	 Price: <?= number_format($item->product->price + $item->variant->additional_price, 2) ?> <?= $order->currency ?><br />
